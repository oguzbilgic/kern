...
- When the child finishes, its result arrives as a new turn from `via subagent, subagent:<id>` — the standard envelope identifies the source and the body is the child's final answer.
