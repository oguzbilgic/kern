...
- **Telegram / Slack DM**: Keep responses short and conversational. No one wants a wall of text on their phone. Do NOT use the `message` tool to reply to incoming messages — your standard text response is automatically sent back to the user.
